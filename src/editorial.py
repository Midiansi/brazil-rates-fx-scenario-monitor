...
'en': {
 ...
 'takeaway':"Rates favor the dollar; oil favors Brazil. USD/BRL near its recent low shows that the dollar case is not yet winning. Wait for a close above 5.22 with firm U.S. yields before considering the trade.",
 ...
 'fx_change':'USD/BRL changed {change}% over approximately one month. A fall means the real strengthened; higher U.S. yields have not yet dominated oil and export support.',
 ...
 'risk':'Main risks: oil and export income keep supporting the real; Brazil preserves its rate advantage; U.S. yields fall; or Brazilian fiscal and election news attracts capital. The oil shock can support exports while also raising global inflation and risk aversion.',
...
'pt': {
 ...
 'takeaway':'Os juros favorecem o dólar; o petróleo favorece o Brasil. O USD/BRL perto da mínima recente mostra que a tese do dólar ainda não venceu. Esperar um fechamento acima de 5,22, com juros americanos firmes, antes de considerar a operação.',
 ...
 'fx_change':'O USD/BRL variou {change}% em aproximadamente um mês. Uma queda significa valorização do real e mostra que os juros americanos mais altos ainda não superaram o apoio do petróleo e das exportações.',
 ...
 'risk':'Principais riscos: petróleo e exportações continuam apoiando o real; o Brasil preserva sua vantagem de juros; os juros americanos caem; ou notícias fiscais e eleitorais atraem capital. O choque do petróleo pode apoiar exportações e, ao mesmo tempo, elevar a inflação e a aversão a risco.',
...
'fr': {
 ...
 'takeaway':"Les taux favorisent le dollar ; le pétrole favorise le Brésil. L'USD/BRL proche de son plus bas récent montre que le scénario dollar ne domine pas encore. Attendre une clôture au-dessus de 5,22 avec des taux américains fermes.",
 ...
 'fx_change':"L'USD/BRL a varié de {change}% sur environ un mois. Une baisse signifie que le real s'est renforcé et que les taux américains plus élevés n'ont pas encore dominé le soutien du pétrole et des exportations.",
 ...
 'risk':"Principaux risques : le pétrole et les exportations continuent de soutenir le real ; le Brésil conserve son avantage de taux ; les taux américains baissent ; ou les nouvelles budgétaires et électorales attirent des capitaux.",
...
COPY['en'].update({
 ...
 'entry_short':'Wait for a daily PTAX midpoint above 5.22, with the U.S. two-year yield near or above 4.56% OR the policy gap actually narrowing. No position at the saved 5.0915 reference.',
 'invalidation_short':'Before entry: abandon the dollar thesis below 5.08 if oil stays firm. After entry: exit after two consecutive daily PTAX midpoints below 5.15, OR if the policy gap fails to narrow.',
 'review_short':'Reassess around 5.36–5.37, or sooner if U.S. yields fall or export support strengthens. This is a review zone, not a guaranteed target.',
...
COPY['pt'].update({
 ...
 'entry_short':'Esperar a PTAX diária fechar acima de 5,22, com o juro americano de dois anos perto ou acima de 4,56% OU com redução efetiva do diferencial de juros. Sem posição na referência salva de 5,0915.',
 'invalidation_short':'Antes da entrada: abandonar a tese do dólar abaixo de 5,08 se o petróleo continuar firme. Após a entrada: sair depois de duas PTAX diárias abaixo de 5,15 OU se o diferencial não diminuir.',
 'review_short':'Reavaliar perto de 5,36–5,37, ou antes se os juros americanos caírem ou o apoio das exportações aumentar. É uma zona de reavaliação, não um alvo garantido.',
...
COPY['fr'].update({
 ...
 'entry_short':"Attendre un point médian PTAX quotidien au-dessus de 5,22, avec le taux américain à deux ans proche ou au-dessus de 4,56 % OU un écart de taux qui diminue réellement. Aucune position au niveau enregistré de 5,0915.",
 'invalidation_short':"Avant l'entrée : abandonner le scénario dollar sous 5,08 si le pétrole reste ferme. Après l'entrée : sortir après deux points médians PTAX sous 5,15 OU si l'écart de taux ne diminue pas.",
 'review_short':"Réexaminer vers 5,36–5,37, ou plus tôt si les taux américains baissent ou si le soutien des exportations se renforce. Zone de réexamen, pas objectif garanti.",
